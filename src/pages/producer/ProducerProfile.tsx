    ...
    <div className="min-h-screen producer-theme bg-producer-background text-producer-foreground animate-fade-in">
      ...
      <main className="max-w-2xl mx-auto p-6 space-y-6">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center justify-between p-5 bg-producer-surface border border-border rounded-2xl hover:border-primary hover-producer-glow transition-smooth group shadow-producer-card">
        ...
        <div className="pt-8">
          <Button variant="outline" className="w-full hover:border-primary hover:text-primary transition-smooth">
